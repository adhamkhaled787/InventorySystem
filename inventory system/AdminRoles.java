 ...
 * @author Adham
 */
public class AdminRoles extends javax.swing.JFrame implements Node {
    ...
    EmployeeUser[] employees = adminrole.getListOfEmployees();

    for (EmployeeUser employee : employees) {
    
    v.tableData.addRow(new Object[]{employee.employeeID, employee.name, employee.email, employee.address, employee.phoneNumber});
}
