...
public class TestClass implements FileNames {
   ...
   private AdminRole admin;
    ...
    public TestClass() {
        ...
        admin = new AdminRole();
        ProductDatabase p2 = new ProductDatabase(PRODUCT_FILENAME);
        CustomerProductDatabase cpd1 = new CustomerProductDatabase(CUSTOMERPRODUCT_FILENAME);
        employee = new EmployeeRole();
    }

    public void testAdminRole() throws FileNotFoundException, IOException {
        ...
        admin.logout();
        EmployeeUserDatabase u1 = new EmployeeUserDatabase("Employees.txt");
        admin = new AdminRole();
    ...
    private boolean addPurchaseOperation(CustomerProduct purchaseOperation) throws FileNotFoundException, IOException {
    ...
    public void testEmployeeRole() throws FileNotFoundException, IOException {
        ...
        if(returnValue != newProducts[oldProducts.length+3].price){
